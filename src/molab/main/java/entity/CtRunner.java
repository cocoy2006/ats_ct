 ...
 */
@Entity
@Table(name = "CT_RUNNER", catalog = "MOLAB")
public class CtRunner implements java.io.Serializable {
	...
	@Column(name = "UNINSTALL_RESULT")
	public String getUninstallResult() {
		return uninstallResult;
	}

	public void setUninstallResult(String uninstallResult) {
